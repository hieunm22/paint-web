...
// scripts/build-sw.mjs rewrites the block below with the file names of one
// build. what stands here serves a worker dev never registers.
/* precache:start */
const CACHE = "paint-web-dev"

/** every file a cold start needs, the hashed bundle included. */
...
/** a built asset answers with Vary: Origin, which a crossorigin tag misses. */
const MATCH = { ignoreVary: true }

/** hashed file names can never go stale: the cache answers them first. */
