...
/** one pixel read by the color picker, with the swatch it lands in. */
...
/**
 * an image point the viewport should center on, carrying the zoom it was asked
...
/** the Show or hide checkboxes, the part of the view that outlives a visit. */
export type ViewToggles = Pick<
	ViewState,
...
/** one of the two centering switches of Page setup. */
