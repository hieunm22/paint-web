...
export class SelectionManager {
	...
	/**
	 * picks the pixels up onto a buffer of their own. `erase` leaves color 2
	...
	/**
	 * re-applies color 2 and the transparency switch to pixels already lifted.
	...
	/**
	 * rotates, flips or resizes the floating pixels about their center. what
	...
	/** paints color 2 over the region, which is Delete and half of Cut. */
	 ...
	 * a lasso leaves gaps in it, and Paint fills those with color 2.
	 */
	 ...
	 * switch and color 2 both stay live while the selection floats.
	 */
	private shade(
		ctx: ToolContext,
...
/** every pixel holding exactly color 2 turns clear, with no tolerance. */
function knockOut(
