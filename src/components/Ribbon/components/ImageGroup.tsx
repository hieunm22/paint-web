...
export function ImageGroup() {
	...
	const selecting = activeTool === "select-rect" || activeTool === "select-free"

	// clicking Select again drops the marquee rather than picking the same tool
	const pickSelect = () => {
		if (hasSelection && selecting)
			paint.deselect()
		else
			dispatch(setTool("select-rect"))
	}
				...
				menu={
					<Menu width={196}>
						...
						<MenuItem
							...
							shortcut={shortcutText("shortcut.image.delete")}
							disabled={!hasSelection}
