...
/** the flyout a row opens, keyed by the action the row carries. */
export const MENU_IDS: Record<string, string> = {
...
export const PANEL_TITLE_KEYS: Record<string, string> = {
	...
	[PRINT_MENU]: "filemenu.item.print",
}

/** the panel's own heading, which the recents list comes back under. */
export const RECENT_TITLE_KEY = "filemenu.recent.title"
