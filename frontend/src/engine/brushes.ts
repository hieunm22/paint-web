...
/** one tile per colour, kept for the life of the page. */
 ...
 * pencil and watercolour borrow the brush of the same name; solid has none.
 */
...
/**
 * sets colour, opacity and texture, then runs `draw` once per pass. an oil
...
/**
 * noise pre-rendered once per colour and repeated as a pattern. node has no
